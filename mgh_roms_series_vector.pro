...
;
; CALLING SEQUENCE
;   result = mgh_roms_series_vector(file, position)
;
; RETURN VALUE:
...
;     together with DEPTH, HEIGHT, PROFILE or SIGMA.
;
...
;     cannot be used together with DEPTH, HEIGHT, LEVEL or SIGMA.
;
...
;     variables having a depth coordinate and it cannot be used
;     together with DEPTH, HEIGHT, LEVEL or PROFILE.
;
...
;-
function mgh_roms_series_vector, ofile, position, $
     DEPTH=depth, HEIGHT=height, LEVEL=level, PROFILE=profile, SIGMA=sigma, $
